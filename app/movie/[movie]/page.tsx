...
import { Props, ActorDetails } from "@/app/interface";
...
export default async function MovieDetail({ params }: Props) {
  ...
  return (
    <div className=" container text-center sm:text-2xl xs:text-2xl mx-auto leading-10 mt-10 mb-10 w-full">
      ...
      <div className="container text-left mx-auto ">
        ...
        <div className="">
          {similarData?.results && (
            <PosterCarousel data={similarData.results} />
          )}
        </div>
      </div>
    </div>
